...
public class GoldBean implements Serializable {
    ...
    public static class DataBean {
        ...
        public int getGolden_coupon_id() {
            return golden_coupon_id;
        }

        public void setGolden_coupon_id(int golden_coupon_id) {
            this.golden_coupon_id = golden_coupon_id;
        }
